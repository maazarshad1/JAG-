    ...
    return (
        <div style={{ flex: 1, backgroundColor: 'var(--bg-main)', display: 'flex', flexDirection: 'column' }}>
            <div className="module-header" style={{ padding: '16px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <h2 className="module-title" style={{ fontSize: '20px', fontWeight: 600, color: '#111827', margin: 0 }}>Reports <i className="fa-solid fa-chevron-down" style={{ fontSize: '12px', marginLeft: '8px', color: '#6b7280' }}></i></h2>
            ...
            <div style={{ padding: '0 24px 24px 24px' }}>
                ...
                <div className="summary-cards" style={{ display: 'flex', gap: '16px', marginBottom: '24px' }}>
                    <div style={{ flex: 1, backgroundColor: '#fff', padding: '20px', borderRadius: '8px', border: '1px solid #e5e7eb' }}>
                        <div className="card-title" style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500, marginBottom: '4px', display: 'flex', alignItems: 'center', gap: '8px' }}><i className="fa-solid fa-chart-line" style={{ color: '#6366f1' }}></i> Total Sales</div>
                    ...
                    <div style={{ flex: 1, backgroundColor: '#fff', padding: '20px', borderRadius: '8px', border: '1px solid #e5e7eb' }}>
                        <div className="card-title" style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500, marginBottom: '4px', display: 'flex', alignItems: 'center', gap: '8px' }}><i className="fa-solid fa-users" style={{ color: '#10b981' }}></i> Total Receivable</div>
                    ...
                    <div style={{ flex: 1, backgroundColor: '#fff', padding: '20px', borderRadius: '8px', border: '1px solid #e5e7eb' }}>
                        <div className="card-title" style={{ fontSize: '13px', color: '#6b7280', fontWeight: 500, marginBottom: '4px', display: 'flex', alignItems: 'center', gap: '8px' }}><i className="fa-solid fa-box" style={{ color: '#3b82f6' }}></i> Stock Valuation</div>
                ...
                <div style={{ display: 'flex', gap: '24px' }}>
                    <div className="table-container" style={{ flex: 2, backgroundColor: '#fff', borderRadius: '8px', border: '1px solid #e5e7eb' }}>
                        <div style={{ padding: '16px', borderBottom: '1px solid #E5E7EB', display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#F9FAFB', borderTopLeftRadius: '8px', borderTopRightRadius: '8px' }}>
                            ...
                            <button onClick={() => onNavigate?.('SALE_LIST')} style={{ fontSize: '12px', color: '#6366f1', fontWeight: 600, background: 'none', border: 'none', cursor: 'pointer' }}>View Sales Ledger</button>
                        </div>
                        <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                            <thead>
                                <tr style={{ borderBottom: '1px solid #E5E7EB', backgroundColor: '#F9FAFB' }}>
                                    ...
                                    <th style={{ padding: '12px 16px', fontSize: '12px', fontWeight: 600, color: '#6B7280', textTransform: 'uppercase' }}>Customer/Party</th>
                            ...
                            <tbody>
                                {sales.slice(-10).reverse().map(sale => (
                                    <tr key={sale.id} style={{ borderBottom: '1px solid #E5E7EB', cursor: 'pointer' }} className="hover:bg-slate-50 transition-colors">
                                        <td style={{ padding: '12px 16px', fontSize: '13px', color: '#4b5563' }}>{sale.date}</td>
                                        <td style={{ padding: '12px 16px', fontSize: '13px', color: '#111827', fontWeight: 500 }}>{sale.customerName}</td>
                                        <td style={{ padding: '12px 16px', fontSize: '13px', color: '#111827', textAlign: 'right', fontWeight: 600 }}>Rs {sale.totalAmount.toLocaleString('en-IN', {minimumFractionDigits: 2})}</td>
                                    </tr>
                                ))}
                                {sales.length === 0 && (
                                    <tr>
                                        <td colSpan={3} style={{ padding: '48px', textAlign: 'center', color: '#9ca3af', fontSize: '13px', fontStyle: 'italic' }}>
                    ...
                    <div style={{ flex: 1, backgroundColor: '#fff', borderRadius: '8px', border: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column' }}>
                        <div style={{ padding: '16px', borderBottom: '1px solid #E5E7EB', display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#F9FAFB', borderTopLeftRadius: '8px', borderTopRightRadius: '8px' }}>
                            ...
                            <span style={{ backgroundColor: '#fee2e2', color: '#b91c1c', fontSize: '10px', padding: '2px 8px', borderRadius: '12px', fontWeight: 700 }}>{lowStockItems.length} NEEDS ATTENTION</span>
                        </div>
                        <div style={{ flex: 1, overflowY: 'auto', padding: '8px' }}>
                            {lowStockItems.length > 0 ? (
                                ...
                                <div style={{ height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', color: '#9ca3af' }}>
                                    ...
                                    <span style={{ fontSize: '13px', fontWeight: 500, color: '#6b7280' }}>Inventory is healthy</span>
